...
currency_list = currency_val("EGP", today)["Currency"][:166]
...
EGP_data.set_index(EGP_data.columns[0], inplace = True)
...
ppp = currency_code["PPP"].loc[currency_code["Currency abbreviation"] == "EGP"].values 
